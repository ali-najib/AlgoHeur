...
## SimulatedAnnealing_prime is an extremely improved version of SimulatedAnnealing, although the degree of improvement does indicate the existence of bugs.
class SimulatedAnnealing_prime():
 ...
 ##################### Experiment and visualize! #######################
    ...
    def plot_expo(self, iteration_count, route_duration, route_count):
        ...
        for i in range(0,11):
            alpha = i/10
            Annealing_result = SimulatedAnnealing_prime(stations, route_duration, route_count).iterate(iteration_count, 10000, 1, alpha, route_duration)
    ...
    def plot_linear(self, iteration_count, route_duration, route_count):
        ...
        for i in range(0,11):
            alpha = i/10
            Annealing_result = SimulatedAnnealing_prime(stations, route_duration, route_count).iterate(iteration_count, 10000, 2, alpha, route_duration)
            plt.plot(Annealing_result[0], Annealing_result[1], linewidth=0.8, label="alpha = {}".format(alpha))
    ...
    def Optimal_lijnvoering_finder(self, iteration_count, route_duration, route_count):
        ...
        for i in range(0, 11):
            alpha = i/10
            K_list_linear.append(SimulatedAnnealing_prime(stations, route_duration, route_count).iterate(iteration_count, 1000, 2, alpha, route_duration))
        ...
        for i in range(0, 11):
            alpha = i/10
            K_list_expo.append(SimulatedAnnealing_prime(stations, route_duration, route_count).iterate(iteration_count, 1000, 1, alpha, route_duration))
        for i in range(0,11):
        ...
        f = open("results/output_annealing_prime.csv", "w")
        f.truncate()
        f.close()
        with open("results/output_annealing_prime.csv", 'w', newline='') as file:
